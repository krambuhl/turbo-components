var Handlebars = require("handlebars/runtime");module.exports = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "<div "
    + this.escapeExpression((helpers.classAttrib || (depth0 && depth0.classAttrib) || alias1).call(depth0,"card",((stack1 = (depth0 != null ? depth0.attribs : depth0)) != null ? stack1.addClass : stack1),{"name":"classAttrib","hash":{},"data":data}))
    + ">"
